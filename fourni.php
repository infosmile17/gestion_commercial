...
<div class="pcoded-main-container">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    ?>
                                                ...
                                                <br>
                                                <div>
                                                    <form action="apiFourni.php" method="POST">
                                        ...
                                        <?php
                                                ...
                                                $msg = 'Erreur de selection du fournisseur !';
    ...
    ";
                                    ...
                                    <div class="card-block">
                                        ...
                                        <div class="animation-model">
                                            ...
                                            <div class="md-modal md-effect-9" id="modal-12">
                                                <div class="md-content">
                                                    <h3>Modifier information fournisseur</h3>
                                                    <div>
                                                        <form action="apiFourni.php" method="POST">
        ...
        <script src='script_fournis.js'></script>
        <script>
